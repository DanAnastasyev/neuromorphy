...
from neuromorphy.training.tagger_model import TaggerModel
from neuromorphy.training.batch_generator import BatchGenerator
...
class ModelTrainer:
    def __init__(self, dict_path: str, train_path: str, val_path: str, test_path: str=None):
        ...
        self._data_info = DataInfoBuilder(morph, train_path, val_path, test_path)
